    ...
    <SafeAreaView style={S.safe}>
      ...
      <View style={S.footer}>
        ...
        {!notification.is_read && !notification.read && (
          <TouchableOpacity style={S.btnPrimary} onPress={() => Alert.alert("Read", "Notification marked as read.")}>
            <Ionicons name="checkmark" size={14} color="#ffffff" />
            <Text style={S.btnPrimaryText}>Mark as Read</Text>
          </TouchableOpacity>
        )}
      </View>
    </SafeAreaView>
...
const S = StyleSheet.create({
  ...
  typeTime: { fontSize: 11, color: C.textMuted, fontFamily: F.mono },

  titleCard: { backgroundColor: C.card, borderRadius: 6, borderWidth: 1, borderColor: C.border, padding: 14 },
  titleText: { fontSize: 15, fontWeight: "600", color: C.textPrimary, fontFamily: F.dm, lineHeight: 22 },

  messageCard: { backgroundColor: C.card, borderRadius: 6, borderWidth: 1, borderColor: C.border, overflow: "hidden" },
  messageLabel: { fontSize: 10, fontWeight: "700", color: "#888888", fontFamily: F.mono, letterSpacing: 2, paddingHorizontal: 14, paddingTop: 12, paddingBottom: 6 },
  messageText: { fontSize: 14, color: C.textSecondary, fontFamily: F.dm, lineHeight: 22, paddingHorizontal: 14, paddingBottom: 14 },

  metaCard: { backgroundColor: C.card, borderRadius: 6, borderWidth: 1, borderColor: C.border, overflow: "hidden" },
  metaTitle: { fontSize: 10, fontWeight: "700", color: "#888888", fontFamily: F.mono, letterSpacing: 2, paddingHorizontal: 14, paddingTop: 12, paddingBottom: 6, borderBottomWidth: 1, borderBottomColor: C.border },
  ...
  metaLabel: { fontSize: 11, color: C.textMuted, fontFamily: F.mono },
  metaValue: { fontSize: 11, fontWeight: "600", color: C.textPrimary, fontFamily: F.dm },
  ...
  btnGhostText: { fontSize: 13, fontWeight: "600", color: C.textSecondary, fontFamily: F.dm },
  btnPrimary: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: C.primary, borderRadius: 3, paddingVertical: 13 },
  btnPrimaryText: { fontSize: 13, fontWeight: "700", color: "#ffffff", fontFamily: F.dm, letterSpacing: 1, textTransform: "uppercase" },
});