...
//tab bar for accessing recurring issues
      ...
      {tabs.map((t) => (
        <button
          ...
          style={{
            ...
            color: active === t.key ? "#2471a3" : "#333",
            background: "none",
            border: "none",
            borderBottom:
              active === t.key ? "2px solid #2471a3" : "2px solid transparent",
            cursor: "pointer",
            fontFamily: FONT,
            marginBottom: "-1px",
          }}
...
export default function CaretakerMaintenance() {
  ...
  function handleTabChange(tab) {
    if (tab === "recurring") {
      navigate("/caretaker/maintenance/recurring");
    } else {
      setActiveTab("all");
    }
  }
  ...
  const filtered = requests.filter((r) => {
    ...
    const propertyMatch =
      !propertyFilter || String(r.property_id) === String(propertyFilter);
    ...
    return statusMatch && propertyMatch && categoryMatch && searchMatch;
  });
  ...
  const urgentOpen = requests.filter(
    (r) =>
      ...
      ["needs_repair", "assigned", "in_progress", "pending_approval"].includes(
        r.status,
      ),
  ).length;
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ ...tdStyle, fontWeight: 600 }}>
                        {r.estimated_cost ? (
                          <span style={{ color: "#8b6e1a" }}>
                            {fmt(r.estimated_cost)}
                          </span>
                        ) : r.actual_cost ? (
                          <span style={{ color: "#2b7a4b" }}>
                            {fmt(r.actual_cost)}
                          </span>
                        ) : (
                          <span style={{ color: "#555" }}>—</span>
