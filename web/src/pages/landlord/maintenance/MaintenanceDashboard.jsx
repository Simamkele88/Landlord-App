...
export default function LandlordMaintenance() {
  ...
  const S = {
    ...
    title: { fontSize: '1.6rem', fontWeight: 700, color: C.white, fontFamily: F.bebas, letterSpacing: '0.04em', display: 'flex', alignItems: 'center', gap: '0.5rem' },
    subtitle: { fontSize: '0.72rem', color: 'rgba(245,240,232,0.35)', fontFamily: F.mono, marginTop: '0.3rem' },
    filterBtn: (active) => ({ padding: '0.4rem 0.85rem', borderRadius: '3px', fontSize: '0.7rem', fontWeight: 600, fontFamily: F.mono, letterSpacing: '0.04em', border: `1px solid ${active ? C.gold : C.border}`, background: active ? 'rgba(232,160,18,0.12)' : 'transparent', color: active ? C.gold : 'rgba(245,240,232,0.4)', cursor: 'pointer', transition: 'all 0.15s', whiteSpace: 'nowrap' }),
    loading: { display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem 0', color: 'rgba(245,240,232,0.3)', gap: '0.8rem', flexDirection: 'column' },
    th: { fontSize: '0.6rem', fontWeight: 600, color: 'rgba(245,240,232,0.3)', fontFamily: F.mono, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '0.7rem 0.8rem', textAlign: 'left', borderBottom: `1px solid ${C.border}`, whiteSpace: 'nowrap' },
    td: { padding: '0.65rem 0.8rem', borderBottom: `1px solid ${C.border}20`, fontSize: '0.75rem' },
    footer: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.8rem 1rem', fontSize: '0.7rem', color: 'rgba(245,240,232,0.3)', fontFamily: F.mono, borderTop: `1px solid ${C.border}` },
  };
