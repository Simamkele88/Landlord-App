                ...
                {properties.map((pro, index) => (
                  <tr key={pro.id}  
                    ...
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                      <button onClick={(e) =>{ 
                        e.stopPropagation();
                        alert("You clicked on edit")}} className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors">
                        Edit property
                      </button>
                    </td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                      <button onClick ={ (e) => {
                        e.stopPropagation();
                        alert("Are you sure you want to remove!")} } className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors">
                        Remove Property
                      </button>
                    </td>
                  </tr>
